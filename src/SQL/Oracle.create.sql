...
ALTER TABLE "Ученик"
	ADD CONSTRAINT "Ученик_FРодит_7708" FOREIGN KEY ("Родитель") REFERENCES "Родитель" ("primaryKey");

CREATE INDEX "Ученик_IРодитель" on "Ученик" ("Родитель");

ALTER TABLE "Ученик"
	ADD CONSTRAINT "Ученик_FКлассУч_0" FOREIGN KEY ("КлассУч") REFERENCES "КлассУч" ("primaryKey");

CREATE INDEX "Ученик_IКлассУч" on "Ученик" ("КлассУч");

ALTER TABLE "Ученик"
	ADD CONSTRAINT "Ученик_FШкола_0" FOREIGN KEY ("Школа") REFERENCES "Школа" ("primaryKey");

CREATE INDEX "Ученик_IШкола" on "Ученик" ("Школа");
