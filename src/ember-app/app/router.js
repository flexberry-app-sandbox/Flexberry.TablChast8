...
Router.map(function () {
  ...
  this.route('i-i-s-tabl-chast8-родитель-e',
  { path: 'i-i-s-tabl-chast8-родитель-e/:id' });
  this.route('i-i-s-tabl-chast8-родитель-e.new',
  { path: 'i-i-s-tabl-chast8-родитель-e/new' });
